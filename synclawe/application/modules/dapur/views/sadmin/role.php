            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $r['role']; ?></td>
                        <td>
                        <a class="btn  btn-warning btn-sm" href="<?php echo base_url('dapur/Admin/roleAccess/').$r['id']; ?>">
                        ...
                        <a href="<?php echo base_url('dapur/Admin/hapus/').$r['id']; ?>" class="btn  btn-danger btn-sm" onclick="return confirm('Are you sure delete?');">
  ...
  <div class="modal fade" id="newRoleModal" tabindex="-1" role="dialog" aria-labelledby="newRoleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('dapur/Admin/role'); ?>" method="post">
 ...
 <div class="modal fade" id="editRoleModal<?php echo $r['id'];?>" tabindex="-1" role="dialog" aria-labelledby="newRoleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('dapur/Admin/editRole'); ?>" method="post">
