...
//		  	  SISTEM INFORMASI				//
//		        MAGANG PHB	  	     //
//			CREATED BY MUHAMAD ASKI BAIHAKI  //
//		FB/LINE/TWITTER/IG @baihaky012       //
//==========================================//
// -->
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index2.html" class="logo">
        ...
        <span class="logo-mini shine"><b>S</b>LW</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg shine"><b>Sync</b>lawe</span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo base_url('assets/Template/dist/img/profile/'). $user['image']; ?>" class="user-image" alt="User Image">
